...
exports.changePassword = async (req, res) => {
    ...
    try {
        ...
        if(matchPassword === newPassword){
            return res.status(400).json({ error: 'New password must different current password'});
        }
...
exports.resetPassword = async (req, res) => {
    ...
    try {
        ...
        const newPassword = pad.substring(0, pad.length - randomPassword.length) + randomPassword
